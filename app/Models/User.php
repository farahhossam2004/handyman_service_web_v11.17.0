...
class User extends Authenticatable implements HasMedia
{
    ...
    {
        return $this->hasOne(ProviderSubscription::class, 'user_id', 'id')->latestOfMany();
    }
    ...
    /**
     * Send the password reset notification using DB mail templates (not Laravel's default Markdown mail).
     *
     * @param  string  $token
     */
    public function sendPasswordResetNotification($token): void
    {
        ...
        })->sendForgotPasswordNotificationForUser($this, $token);
    }
}
