...
class UserResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $referralRule = LoyaltyReferralRule::where('status', 1)
                        ...
                        ->first();
        $referrer_points = $referralRule ? $referralRule->referrer_points : 0;
        $referred_user_points = $referralRule ? $referralRule->referred_user_points : 0;
        ...
        return [
            ...
            'national_id_image' => $this->national_id_image_url,
            ...
            'known_languages' => is_array($this->known_languages) ? implode(',', $this->known_languages) : ($this->known_languages ?? ''),
            'skills' => $this->skills,
            ...
            'referred_user_points' => $referred_user_points,
        ];
    }
}
