...
class ServiceDetailResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $user_id = request()->has('customer_id') ? (request()->customer_id ?? Auth::id()) : null;
        ...
        $sitesetupValue = $sitesetup ? json_decode($sitesetup->value) : null;
        ...
        return [
            ...
            'advance_payment_amount' => $this->is_enable_advance_payment == 1 ? ($this->advance_payment_amount === null ? 0 : (float) $this->advance_payment_amount) : (float) $advancePaymentPercentage,
