...
use App\Http\Resources\API\BookingChargesResource;
use App\Http\Resources\API\BookingPackageResource;
...
class BookingResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'payment_status'        => (optional($this->service)->price == 0 || $this->total_amount == 0) ? 'free' : ($payment ? $payment->payment_status : null),
            'payment_status_label'  => booking_payment_status_label($payment, $this),
            ...
            'duration_diff'         => (string)$this->duration_diff,
            ...
            'advance_paid_amount'   => $this->advance_paid_amount == null ? 0 : (float) $this->advance_paid_amount,
            ...
            'shop_data' => $this->shop ? [
                ...
                'country_name'   => optional($this->shop->country)->name,
                'state_name'     => optional($this->shop->state)->name,
                'city_name'      => optional($this->shop->city)->name,
