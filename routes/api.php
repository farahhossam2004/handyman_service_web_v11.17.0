...
Route::get('nearby-providers', [API\CommanController::class, 'getNearbyProviders']);
...
Route::get('available-slots', [API\BookingController::class, 'getAvailableSlots']);
...
Route::post('zone-save', [API\ServiceZoneController::class, 'saveZone']);
Route::get('zone-detail', [API\ServiceZoneController::class, 'getZoneDetail']);

Route::get('shop-list', [API\ShopController::class, 'getShopList'])->middleware('shop.module.enabled');
Route::get('shop-detail/{id}', [API\ShopController::class, 'getShopDetail'])->middleware('shop.module.enabled');
Route::get('shop-hours-list/{id}', [API\ShopController::class, 'getShopHoursList']);

Route::group(['middleware' => ['auth:sanctum']], function () {

    // shop api
    Route::middleware('shop.module.enabled')->group(function () {
        ...
        Route::post('shop-hours-store/{id}', [API\ShopController::class, 'shopHoursStore']);
    });
    ...
    Route::post('phonepe/create-order', [API\PaymentController::class, 'phonePeCreateOrder']);
    Route::post('phonepe/verify-order', [API\PaymentController::class, 'phonePeVerifyOrder']);
    ...
    Route::post('download-subscription-invoice', [API\SubscriptionController::class, 'downloadSubscriptionInvoice']);
    ...
    Route::post('provider-service-status', [API\ServiceController::class, 'providerServiceStatus']);
...
Route::match(['get', 'post'], '/phonepe/callback-v2', [API\BookingController::class, 'callbackV2']);
