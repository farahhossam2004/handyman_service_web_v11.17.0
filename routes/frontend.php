...
Route::middleware([CheckInstallation::class])->group(function () {
    ...
    Route::get('/nearby-providers', [FrontendController::class, 'nearbyProviders'])->name('frontend.nearby_providers');
    Route::get('/shop-list', [FrontendController::class, 'shopList'])->middleware('shop.module.enabled')->name('shop.list');
    ...
    Route::get('/shop-detail/{id}', [FrontendController::class, 'shopDetail'])->middleware('shop.module.enabled')->name('shop.detail');
...
Route::get('/shop-datatable', [FrontendController::class, 'shopDatatable'])->middleware('shop.module.enabled')->name('shop.data');
...
Route::get('payment/success/{transaction_id?}', [App\Http\Controllers\HomeController::class, 'paymentSuccess'])->name('payment.success');
Route::get('payment/failed/{transaction_id?}', [App\Http\Controllers\HomeController::class, 'paymentFailed'])->name('payment.failed');
