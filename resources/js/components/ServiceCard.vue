<template>
  ...
  <div class="iq-image position-relative">
     ...
     <div v-if="visit_type == 'on_shop'"  class="position-absolute d-flex justify-content-center align-items-center rounded-circle bg-primary"
...
const isFavouriteLocal = ref(props.favourite);
watch(() => props.favourite, (newVal) => {
    isFavouriteLocal.value = newVal;
}, { immediate: true });
