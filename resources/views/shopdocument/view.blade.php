<x-master-layout>
        ...
        <div class="row">
            ...
            <div class="card card-block card-stretch">
                ...
                <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                    ...
                    @if($auth_user->can('shopdocument add'))
                    <a href="{{ route('shopdocument.create',['providerdocument' => $providerdata->id]) }}" class=" float-end me-1 btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> {{ trans('messages.add_form_title',['form' => trans('messages.shop_document')  ]) }}</a>
                    @endif
                </div>
                </div>
            </div>
        ...
        <div class="card-body">
          <div class="row justify-content-between gy-3">
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="col-md-12">
                    <form action="{{ route('shopdocument.bulk-action') }}" id="quick-action-form" class="form-disabled d-flex gap-3 align-items-center">
                        @csrf
                        ...
                        data--submit="{{ route('shopdocument.bulk-action') }}"
                        data-datatable="reload" data-confirmation='true'
                        data-title="{{ __('shopdocument',['form'=>  __('shopdocument') ]) }}"
                        title="{{ __('shopdocument',['form'=>  __('shopdocument') ]) }}"
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="d-flex align-items-center gap-3 justify-content-end">
                    <div class="d-flex justify-content-end gap-3">
                        <div class="datatable-filter ms-auto w-100">
                        ...
                        <div class="input-group input-group-search ms-2 w-100">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', (event) => {
            let canDelete = {{ json_encode($auth_user->can('shopdocument delete')) }};
            ...
            if (canDelete) {
                columns.push({
                    name: 'check',
                    data: 'check',
                    title: '<input type="checkbox" class="form-check-input" name="select_all_table" id="select-all-table" data-type="shopdocument" onclick="selectAllTable(this)">',
                    exportable: false,
                    orderable: false,
                    searchable: false,
                });
            ...
            window.renderedDataTable = $('#datatable').DataTable({
                ...
                ajax: {
                    type: "GET",
                    url: '{{ route("shopdocument.index_data", ["provider_id" => $providerdata->id]) }}',
                    data: function(d) {
                ...
                columns: columns,
                order: [[ 1 , 'desc']], // adjust order index if check column exists
                language: {
