                    ...
                    <div class="table-responsive mt-5 mb-5">
                        <table class="table text-start mb-0">
                            <tbody>
                                ...
                                @php
                                    $rawLangs = $providerData['data']['known_languages'] ?? '';
                                    $langsArray = is_array($rawLangs)
                                        ? $rawLangs
                                        : (str_starts_with(trim((string)$rawLangs), '[')
                                            ? ((array) json_decode($rawLangs))
                                            : array_filter(array_map('trim', explode(',', $rawLangs))));
                                    $langsArray = array_values(array_filter($langsArray));
                                @endphp
                                @if (!empty($langsArray))
                                    <tr>
                                        ...
                                        <td class="py-3 border-bottom">
                                            <span class="font-size-18">{{ implode(', ', $langsArray) }}</span>
                                        </td>
                                    </tr>
                                @endif
                                                            ...
                                                            <div class="text-muted">
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <span>
                                                                        ...
                                                                        {{ implode(', ', array_filter([$shop->address, $shop->city->name ?? null, $shop->state->name ?? null, $shop->country->name ?? null])) }}
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        </div>
                    ...
                    @if (default_earning_type() === 'commission' ||
                        ...
                        @if (!empty($providerData['service']))
                            <div class="row align-items-center pt-3 mb-5">
                                ...
                                @if (count($providerData['service']) > 2)
                                    <div class="col-sm-3 mt-sm-0 mt-3 text-sm-end">
                                        <a
