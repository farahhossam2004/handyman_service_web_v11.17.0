...
@section('content')
    @if (session('success'))
        ...
        ">
            ...
            <button type="button" data-bs-dismiss="alert" aria-label="Close"
                style="margin-left: 15px; background: none; border: none; color: #90EE90;">
                DISMISS
            </button>
        </div>
                            ...
                            @if ($sectionData && isset($sectionData['section_1']) && $sectionData['section_1']['section_1'] == 1)
                                ...
                                @if (isset($user_lat) && isset($user_lng) && $user_lat != null && $user_lng != null)
                                    <location-search :user_id="{{ json_encode($auth_user_id) }}"
                                        ...
                                        :user_lng={{ $user_lng ?? '' }}></location-search>
                                @else
                                    <location-search :user_id="{{ json_encode($auth_user_id) }}"
    ...
    <div class="section-padding bg-light our-service">
        <div class="container">
            @if (
                (isset($sectionData['section_3']) && $sectionData['section_3']['section_3'] == 1) ||
                    (isset($sectionData['section_4']) && $sectionData['section_4']['section_4'] == 1))
                ...
                @if ($sectionData && isset($sectionData['section_3']) && $sectionData['section_3']['section_3'] == 1)
                    <div>
                        ...
                        @if (isset($user_lat) && isset($user_lng) && $user_lat != null && $user_lng != null)
                            <service-slider-section :user_lat={{ $user_lat ?? '' }} :user_lng={{ $user_lng ?? '' }}
                                :user_id="{{ json_encode($auth_user_id) }}" :favourite="{{ json_encode($favourite) }}"
                                :type="'ac'" />
                        @else
    ...
    {{-- shop --}}
    @if (optional($serviceconfig)->shop == 1)
        <div class="section-padding ">
            <div class="container">
                <div>
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                        ...
                                        <div class="mt-5 justify-content-center service-slide-items-4">
                                            <div class="col">
                                                <div class="service-box-card bg-light rounded-3 mb-5">
                                                    ...
                                                    <a href="{{ route('shop.detail', $shop->id) }}" class="service-heading mt-4 d-block p-0">
                                                        <h5 class="service-title font-size-18 line-count-2">
                                                            {{ $shop->translate('shop_name') ?: 'shop_name' }}</h5>
                                                    </a>
                                                    <div class="mt-3">
