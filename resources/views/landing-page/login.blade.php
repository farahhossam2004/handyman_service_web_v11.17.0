                        ...
                        <div class="col-xl-8 col-lg-10">
                            <div class="authontication-forms">
                                ...
                                <div class="iq-login-form ">
                                    ...
                                    {{-- Show session/validation errors (e.g. "Please verify email first") --}}
                                    @if ($errors->any())
...
<script>
    $(document).ready(function () {
        ...
        $('#loginForm').submit(function (e) {
            ...
            $('#error').addClass('d-none').text(''); // Clear previous error
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.data) {
                        ...
                        if (serviceId) {
                            if(shopId){
                                window.location.href = `${baseUrl}/book-service?id=${serviceId}&shop_id=${shopId}`;
                            }else{
