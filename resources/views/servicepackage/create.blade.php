...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    {{ html()->form('POST', route('servicepackage.store'))->attribute('enctype', 'multipart/form-data')->attribute('data-toggle', 'validator')->attribute('data-language-required-mode', 'active')->id('servicepackage')->open()}}
                ...
                <div class="form-group col-md-{{ $field === 'name' ? '4' : '4' }}">
                    ...
                    @php
                        ...
                        if ($servicepackage && $servicepackage->id) {
                            $translation = $servicepackage->translations()
                        ...
                        if ($language['id'] === 'en') {
                            $value = $servicepackage->getAttribute($field) ?? '';
...
$(document).ready(function() {
    ...
    // Auto-fill English tab when creating new package
    // When a non-English language tab is filled and English tab is empty, copy the value
