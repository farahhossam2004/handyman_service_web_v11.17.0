                ...
                <div class="card card-block card-stretch">
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3">
                            ...
                            <a href="{{ route('servicefaq.create',['service_id'=> $service_id]) }}" class=" float-end me-1 btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i>
                                 {{-- {{ trans('messages.add_form_title',['form' => trans('messages.servicefaq')  ]) }} --}}
                                 {{ __('messages.new') }}
                                </a>
                            @endif
                        </div>
