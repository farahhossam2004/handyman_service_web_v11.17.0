        ...
        <div class="pay-booking-details">
            ...
            <div class="d-flex justify-content-between gap-2 mb-2">
                ...
                <span id="payment_status__span"
                    class="{{ isset($payment) && in_array($payment->payment_status, ['paid', 'advanced_paid'], true) ? 'text-success' : 'text-danger' }}">
                    {{ isset($payment) ? booking_payment_status_label($payment, $bookingdata) : __('messages.pending')}}
                </span>
            </div>
