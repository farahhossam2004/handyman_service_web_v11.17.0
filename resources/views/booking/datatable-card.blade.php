   ...
   <div class="row align-items-center">
      ...
      <div class="col-lg-8 mt-5 mt-lg-0">
         <h5 class="booking-title text-capitalize line-count-1">
            ...
            @endif
            @if($is_at_shop)
                <span class="badge bg-primary ms-2 align-middle rounded-1" style="font-size: 14px;">At Shop</span>
            @endif
         </h5>
         ...
         <div class="row mt-5">
            <div class="col-lg-6 col-md-5">
               ...
               <ul class="list-inline m-0">
                  ...
                  <li>
                   @if($data->service && $data->service->price == 0) <!-- Check if service exists and is free -->
                    <li class="mb-2">
                        <span class="d-flex gap-3">
                            <span class="d-inline-block w-25 fw-bold">{{__('landingpage.service_type')}}:</span>
                            <span class="d-inline-block" style=" color: #5F60B9; font-weight: bold; font-size: 18px;">
                                {{ __('landingpage.free') }}
                            </span> <!-- "Free" label with box -->
                        </span>
                    </li>
                    @endif
                     ...
                     <span class="d-flex gap-3">
                         ...
                         @if(!empty($payment))
                             @if($payment->payment_type === 'cash' && $payment->payment_status === 'pending')
                                 <span class="d-inline-block w-75 status-text text-warning text-capitalize">{{ booking_payment_status_label($payment) }}</span>
                             @else
