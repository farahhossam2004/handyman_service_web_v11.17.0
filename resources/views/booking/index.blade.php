<x-master-layout>
    ...
    <div class="container-fluid">
        ...
        <x-advance-filter>
            ...
            @endif
            <div class="form-group datatable-filter">
                <label class="form-label" for="shop_id">{{ __('messages.shop_label') }}</label>
                <select name="shop_name[]" id="shop_id" class="form-select select2" data-filter="select" multiple
                    data-ajax--url="{{ route('ajax-list', ['type' => 'shop']) }}" data-ajax--cache="true"
                    data-placeholder="{{ __('messages.all_shops') }}">
                </select>
            </div>
