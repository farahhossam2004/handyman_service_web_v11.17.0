        ...
        <div class=" pb-3">
            ...
            <div class="vertical-timeline mb-4">
                    ...
                    <div class="timeline-content">
                        ...
                        <div class="timeline-info">
                            ...
                            <div class="timeline-details">
                                <p class="mt-2">New Booking Added by
                ...
                @if (optional($bookingdata->payment)->payment_status == 'Advanced Refund')
                    <div class="timeline-item {{ $bookingdata->status == 'pending' ? 'active' : '' }}">
                        ...
                        <div class="timeline-content">
                            <div class="point"></div>
                            <div class="timeline-info">
                                <p class="fs-4"><strong>{{ __('messages.wallet_refunded') }}</strong></p>
                                <div class="timeline-details">
                                    <p class="mt-2">Refund for Booking #{{ $bookingdata->id }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="timeline-connector"></div>
                ...
                @else
                    ...
                    <div
                        class="timeline-item {{ $bookingdata->status == 'accept' && $bookingdata->handymanAdded->count() == 0 ? 'active' : '' }}">
                        <div class="timeline-date">
                    ...
                    @if ($bookingdata->handymanAdded->count() > 0)
                        <!-- Show assigned only if handyman is assigned and status is not 'pending' or 'accept' -->
                        <div
                            class="timeline-item {{ ($bookingdata->status == 'assigned' || $bookingdata->handymanAdded->count() > 0 || !empty($bookingdata->provider_id)) && $bookingdata->status != 'completed' && $bookingdata->status != 'cancelled' ? 'active' : '' }}">
                            <div class="timeline-date">
                                @if ($bookingdata->status != 'pending')
                                    <!-- Check if status is neither 'pending' nor 'accept' -->
                                    {{ \Carbon\Carbon::parse($bookingdata->updated_at)->timezone($timezone)->format($datetime->time_format) }}
                                    <div class="date-details">
                                        {{ \Carbon\Carbon::parse($bookingdata->updated_at)->timezone($timezone)->format($datetime->date_format) }}
                                    </div>
                            ...
                            <div class="timeline-content">
                                ...
                                <div class="timeline-info">
                                    ...
                                    <div class="timeline-details">
                                        @foreach ($bookingdata->handymanAdded as $handyman)
                                            <p class="mt-2">Service Assigned to
                                                {{ optional($handyman->handyman)->display_name }}</p>
                                        @endforeach
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="timeline-item {{ $bookingdata->status == 'completed' ? 'active' : '' }}">
                        ...
                        <div class="timeline-content">
                            ...
                            <div class="timeline-info">
                                ...
                                <div class="timeline-details">
                                    @if ($bookingdata->status == 'completed')
                                        <p class="mt-2">Service Completed - Final Amount:
                                            {{ getPriceFormat($bookingdata->total_amount) }}</p>
                                    @else
                                        <p class="mt-2 text-muted">Pending completion</p>
                                    @endif
                                </div>
            ...
            <div class="card-body bg-body">
                <ul class="list-unstyled">
                    ...
                    <li class="d-flex justify-content-between mb-2 p-2">
                        ...
                        <strong><span
                                class="text-primary">{{ isset($bookingdata->status) ? ucwords(str_replace('_', ' ', $bookingdata->status)) : __('messages.pending') }}</span></strong>
                    </li>
                    <li class="d-flex justify-content-between mb-2 p-2">
