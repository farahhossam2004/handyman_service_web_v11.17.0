    ...
    <div class="container-fluid">
                ...
                <div class="card card-block card-stretch">
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                            ...
                            @php
                                // Preserve filters/pagination by using referrer; fallback to list route
                                $backUrl = url()->previous();
                                $path = parse_url($backUrl, PHP_URL_PATH) ?: '';
                                if (empty($backUrl) || strpos($path, 'loyalty-history') === false) {
                                    $backUrl = route('loyalty_history.view');
                                }
                            @endphp
        ...
        <div class="card">
            <div class="card-body">
                            ...
                            <div
                                ...
                                <div class="p-3 bg-white rounded-circle">
                                    <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M13.0014 5.90906C14.6331 5.90906 15.9559 4.58627 15.9559 2.95453C15.9559 1.32279 14.6331 0 13.0014 0C11.3697 0 10.0469 1.32279 10.0469 2.95453C10.0469 4.58627 11.3697 5.90906 13.0014 5.90906Z" fill="#9CA3AF"/>
                                        <path d="M8.94965 11.8182H17.0539C17.7521 11.8182 18.32 11.2053 18.32 10.4517V10.0732C18.32 9.0858 17.8312 8.18387 17.0435 7.7193C16.1 7.163 14.6331 6.5 13.0018 6.5C11.3704 6.5 9.90355 7.16306 8.96007 7.7193C8.17237 8.18382 7.68359 9.0858 7.68359 10.0732V10.4517C7.68359 11.2054 8.25142 11.8182 8.94965 11.8182Z" fill="#9CA3AF"/>
                                        <path d="M5.31781 20.0907C6.94955 20.0907 8.27234 18.7679 8.27234 17.1362C8.27234 15.5044 6.94955 14.1816 5.31781 14.1816C3.68607 14.1816 2.36328 15.5044 2.36328 17.1362C2.36328 18.7679 3.68607 20.0907 5.31781 20.0907Z" fill="#9CA3AF"/>
                                        <path d="M9.35989 21.9009C8.41642 21.3446 6.94954 20.6816 5.31819 20.6816C3.68683 20.6816 2.21995 21.3447 1.27648 21.9009C0.488774 22.3655 0 23.2674 0 24.2547V24.6333C0 25.3869 0.567827 25.9998 1.26606 25.9998H9.37031C10.0685 25.9998 10.6364 25.3869 10.6364 24.6333V24.2547C10.6364 23.2674 10.1476 22.3655 9.35989 21.9009Z" fill="#9CA3AF"/>
                                        <path d="M20.6811 20.0907C22.3128 20.0907 23.6356 18.7679 23.6356 17.1362C23.6356 15.5044 22.3128 14.1816 20.6811 14.1816C19.0494 14.1816 17.7266 15.5044 17.7266 17.1362C17.7266 18.7679 19.0494 20.0907 20.6811 20.0907Z" fill="#9CA3AF"/>
                                        <path d="M24.7232 21.9009C23.7797 21.3446 22.3128 20.6816 20.6815 20.6816C19.0501 20.6816 17.5832 21.3447 16.6398 21.9009C15.8521 22.3655 15.3633 23.2674 15.3633 24.2548V24.6333C15.3633 25.387 15.9311 25.9998 16.6293 25.9998H24.7336C25.4318 25.9998 25.9997 25.387 25.9997 24.6333V24.2548C25.9996 23.2674 25.5108 22.3655 24.7232 21.9009Z" fill="#9CA3AF"/>
                                        <path d="M15.9526 20.0909C16.1263 20.0909 16.2977 20.0147 16.4149 19.8693C16.6186 19.6143 16.577 19.2426 16.3225 19.0384L13.5896 16.852V13.5909C13.5896 13.2643 13.3253 13 12.9986 13C12.672 13 12.4077 13.2642 12.4077 13.5909V16.8524L9.67478 19.0383C9.42028 19.2426 9.37873 19.6142 9.58243 19.8693C9.6996 20.0147 9.87094 20.0909 10.0447 20.0909C10.1739 20.0909 10.3044 20.0488 10.4134 19.9616L12.9986 17.8935L15.5838 19.9616C15.6929 20.0488 15.8233 20.0909 15.9526 20.0909Z" fill="#9CA3AF"/>
                                    </svg>
                                </div>
                            </div>
                        </div>
                ...
                <div class="m-3">
                    <div class="d-flex justify-content-end gap-4 flex-wrap align-items-center">
                        <div class="datatable-filter">
                            <select name="filter" id="filter" class="select2 form-select"
                                data-filter="select" style="width: 140px">
