...
<div class="form-group">
    <div class="form-control d-flex align-items-center justify-content-between">
        <label for="shop" class="mb-0">{{ __('messages.enable_shop') }}</label>
        <div class="custom-control custom-switch custom-switch-text custom-switch-color custom-control-inline">
            <input type="checkbox" class="custom-control-input" name="shop" id="shop" {{ !empty($serviceconfig->shop) ? 'checked' : '' }}>
            <label class="custom-control-label" for="shop"></label>
        </div>
    </div>
</div>
