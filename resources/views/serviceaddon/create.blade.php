    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        {{ html()->form('POST', route('serviceaddon.store'))->attribute('enctype', 'multipart/form-data')->attribute('novalidate', 'novalidate')->id('serviceaddon')->open() }}
                            ...
                            <div id="form-language-{{ $language['id'] }}" class="language-form" style="display: {{ $language['id'] == app()->getLocale() ? 'block' : 'none' }};">
                                ...
                                <div class="form-group col-md-{{ $field === 'name' ? '4' : '12' }}">
                                    ...
                                    @php
                                        ...
                                        if ($serviceaddon && $serviceaddon->id) {
                                            $translation = $serviceaddon->translations()
                                    ...
                                    if ($language['id'] === 'en') {
                                        $value = $serviceaddon->getAttribute($field) ?? '';
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 mb-2">
                                <div class="image-preview-container">
                                    ...
                                    href="{{ route('remove.file', ['id' => $serviceaddon->id, 'type' => 'serviceaddon_image']) }}"
          ...
          <script type="text/javascript">
            // Disable inputs on hidden language tabs so browser validation skips them
            function syncLanguageInputStates() {
