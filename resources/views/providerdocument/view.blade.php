        ...
        <div class="card card-block card-stretch">
          <div class="card-body p-0">
            <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
              ...
              <a href="{{ route('providerdocument.create',['providerdocument' => $providerdata->id]) }}" class=" float-end me-1 btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i>
                 {{-- {{ trans('messages.add_form_title',['form' => trans('messages.providerdocument')  ]) }} --}}
                 {{ __('messages.new') }}
                </a>
              @endif
            </div>
