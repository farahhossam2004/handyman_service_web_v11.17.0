...
<div class="d-flex justify-content-end align-items-center ms-2">
    @if(!$provider_document->trashed())
        <a class="me-2" href="{{ route('providerdocument.detail', $provider_document->id) }}" title="{{ __('messages.view_form_title',['form' => __('messages.providerdocument')]) }}"><i class="fas fa-eye text-secondary"></i></a>
