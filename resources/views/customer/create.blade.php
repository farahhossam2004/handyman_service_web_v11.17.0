                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                {{ html()->textarea('address', $customerdata->address)->class('form-control textarea')->rows(3)->id('address')->placeholder(__('messages.address')) }}
                                {{ html()->hidden('latitude', $customerdata->latitude)->id('latitude') }}
                                {{ html()->hidden('longitude', $customerdata->longitude)->id('longitude') }}
                            </div>

                            <div class="form-group col-md-4">
                                {{ html()->label(__('messages.select_name', ['select' => __('messages.country')]), 'country_id')->class('form-control-label') }}
                                <br />
                                {{ html()->select('country_id', [optional($customerdata->country)->id => optional($customerdata->country)->name], optional($customerdata->country)->id)
...
@section('bottom_script')
    ...
    <script>
    // Initialize common phone input handler
    $(document).ready(function() {
        ...
        var country_id = "{{ isset($customerdata->country_id) ? $customerdata->country_id : 0 }}";
