                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                {{ html()->label(__('messages.contact_number').' <span class="text-danger">*</span>', 'contact_number')->class('form-control-label') }}<br />
                                {{ html()->text('contact_number', $handymandata->contact_number)->placeholder(__('messages.contact_number'))->class('form-control contact_number')->required() }}<br />
                            ...
                            <div class="form-group col-md-4">
                                ...
                                {{ html()->select('status', ['1' => __('messages.active'), '0' => __('messages.inactive')], old('status', $handymandata->status ?? null))->class('form-select select2js')->required() }}
                            </div>
<!--
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                {{ html()->textarea('address', $handymandata->address)->class('form-control textarea')->rows(3)->id('address')->placeholder(__('messages.address')) }}
                                {{ html()->hidden('latitude', $handymandata->latitude)->id('latitude') }}
                                {{ html()->hidden('longitude', $handymandata->longitude)->id('longitude') }}
                            </div>
        ...
        "use strict";
            ...
            if (typeof PhoneInputHandler !== 'undefined' && typeof window.intlTelInput !== 'undefined') {
                PhoneInputHandler.init({
                    ...
                    errorSelector: '#contact_number_err',
