...
class NotificationTemplateSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $template = NotificationTemplate::create([
            ...
            'status' => 1,
            'to' => '["admin","provider"]',
            'channels' => ['IS_MAIL' => '1', 'PUSH_NOTIFICATION' => '1', 'IS_SMS' => '0', 'IS_WHATSAPP' => '0'],
        ]);
        $template->defaultNotificationTemplateMap()->create([
            'language' => 'en',
            'notification_link' => '',
            ...
            'whatsapp_subject' => 'Subscription Cancelled',
            'sms_subject' => 'Subscription Cancelled',
            'template_detail' => '<p>[[ provider_name ]] has cancelled their subscription plan [[ plan_name ]].</p>',
            'whatsapp_template_detail' => '<p>[[ provider_name ]] has cancelled their subscription plan [[ plan_name ]].</p>',
            'sms_template_detail' => '<p>[[ provider_name ]] has cancelled their subscription plan [[ plan_name ]].</p>',
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'whatsapp_subject' => 'Subscription Cancelled Successfully',
            'sms_subject' => 'Subscription Cancelled Successfully',
            'template_detail' => '<p>Your subscription plan [[ plan_name ]] has been cancelled successfully.</p>',
            'whatsapp_template_detail' => '<p>Your subscription plan [[ plan_name ]] has been cancelled successfully.</p>',
            'sms_template_detail' => '<p>Your subscription plan [[ plan_name ]] has been cancelled successfully.</p>',
        ...
        $template = NotificationTemplate::create([
            ...
            'status' => 1,
            'to' => '["admin","provider"]',
            'channels' => ['IS_MAIL' => '1', 'PUSH_NOTIFICATION' => '0', 'IS_SMS' => '0', 'IS_WHATSAPP' => '0'],
        ]);
        $template->defaultNotificationTemplateMap()->create([
            'language' => 'en',
            'notification_link' => '',
            ...
            'whatsapp_template_detail' => '<p>[[ provider_name ]]\'s subscription plan [[ plan_name ]] has expired.</p>',
            'sms_template_detail' => '<p>[[ provider_name ]]\'s subscription plan [[ plan_name ]] has expired.</p>',
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'whatsapp_subject' => 'Your Subscription Has Expired',
            'sms_subject' => 'Your Subscription Has Expired',
            'template_detail' => '<p>Your subscription plan [[ plan_name ]] has expired.</p>',
            'whatsapp_template_detail' => '<p>Your subscription plan [[ plan_name ]] has expired.</p>',
            'sms_template_detail' => '<p>Your subscription plan [[ plan_name ]] has expired.</p>',
        ...
        foreach (['admin', 'provider', 'handyman', 'user'] as $ut) {
            $template->defaultNotificationTemplateMap()->create([
                ...
                'whatsapp_subject' => 'Forgot Password',
                'sms_subject' => 'Forgot Password',
                'template_detail' => '<p>Password reset requested for [[ user_email ]].</p>',
                'whatsapp_template_detail' => '<p>Password reset requested.</p>',
                'sms_template_detail' => 'Password reset requested.',
                'mail_template_detail' => $forgotPasswordMailBody,
            ]);
        }
        ...
        foreach (['admin', 'provider', 'handyman', 'user'] as $ut) {
            $template->defaultNotificationTemplateMap()->create([
                ...
                'whatsapp_subject' => 'Password Reset Successful',
                'sms_subject' => 'Password Reset Successful',
                'template_detail' => '<p>Your password was updated for [[ user_email ]].</p>',
                'whatsapp_template_detail' => '<p>Your password was updated.</p>',
                'sms_template_detail' => 'Your password was updated.',
                'mail_template_detail' => $passwordResetSuccessBody,
            ]);
        }
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'whatsapp_subject' => 'Email verification',
            'sms_subject' => 'Email verification',
        ...
        $template = NotificationTemplate::create([
            ...
            'description' => 'Notification when a new shop is created (by provider or admin)',
            'status' => 1,
            'to' => '["admin","provider","user"]',
            'channels' => ['IS_MAIL' => '1', 'PUSH_NOTIFICATION' => '0', 'IS_SMS' => '0', 'IS_WHATSAPP' => '0'],
        ]);
        $template->defaultNotificationTemplateMap()->create([
            'language' => 'en',
            'notification_link' => '',
            'notification_message' => 'A new shop "[[ shop_name ]]" has been created.',
            'user_type' => 'admin',
            'status' => 1,
            'subject' => 'New Shop Created',
            'mail_subject' => 'New Shop Created',
            'template_detail' => '<p>Hello [[ admin_name ]],</p><p>A new shop "[[ shop_name ]]" has been created by provider [[ provider_name ]].</p>',
            'mail_template_detail' => '<p>Hello [[ admin_name ]],</p><p>A new shop "[[ shop_name ]]" has been created by provider [[ provider_name ]].</p>',
        ]);
        $template->defaultNotificationTemplateMap()->create([
            'language' => 'en',
            'notification_link' => '',
            'notification_message' => 'A new shop "[[ shop_name ]]" has been created for you.',
            'user_type' => 'provider',
            'status' => 1,
            'subject' => 'New Shop Created',
            'mail_subject' => 'New Shop Created',
            'template_detail' => '<p>Hello [[ provider_name ]],</p><p>A new shop "[[ shop_name ]]" has been created for you.</p>',
            'mail_template_detail' => '<p>Hello [[ provider_name ]],</p><p>A new shop "[[ shop_name ]]" has been created for you.</p><p>Best regards,<br>[[ company_name ]]</p>',
        ]);
        $template->defaultNotificationTemplateMap()->create([
            'language' => 'en',
            'notification_link' => '',
            'notification_message' => 'A new shop "[[ shop_name ]]" is now available.',
            'user_type' => 'user',
            'status' => 1,
            'subject' => 'New Shop Created',
            'mail_subject' => 'New Shop Created',
            'template_detail' => '<p>Hello [[ user_name ]],</p><p>A new shop "[[ shop_name ]]" is now available on the platform.</p>',
            'mail_template_detail' => '<p>Hello [[ user_name ]],</p><p>A new shop "[[ shop_name ]]" is now available on the platform.</p> <p>Best regards,<br>[[ company_name ]]</p>',
        ]);
        ...
        $template = NotificationTemplate::create([
            ...
            'description' => 'Notification when shop status is activated',
            'status' => 1,
            'to' => '["admin","provider"]',
            'channels' => ['IS_MAIL' => '1', 'PUSH_NOTIFICATION' => '0', 'IS_SMS' => '0', 'IS_WHATSAPP' => '0'],
        ]);
        $template->defaultNotificationTemplateMap()->create([
            'language' => 'en',
            'notification_link' => '',
            'notification_message' => 'Shop "[[ shop_name ]]" status has been activated.',
            'user_type' => 'admin',
            'status' => 1,
            'subject' => 'Shop activated',
            'mail_subject' => 'Shop activated',
            'template_detail' => '<p>Hello [[ admin_name ]],</p><p>Shop "[[ shop_name ]]"  is currently available on the platform.</p>',
            'mail_template_detail' => '<p>Hello [[ admin_name ]],</p><p>Shop "[[ shop_name ]]"  is currently available on the platform.</p> <p>Best regards,<br>[[ company_name ]]</p>',
        ]);
        
        $template->defaultNotificationTemplateMap()->create([
            'language' => 'en',
            'notification_link' => '',
            'notification_message' => 'Your shop "[[ shop_name ]]" status has been activated.',
            'user_type' => 'provider',
            'status' => 1,
            'subject' => 'Shop activated',
            'mail_subject' => 'Your shop activated',
            'template_detail' => '<p>Hello [[ provider_name ]],</p><p>Your shop "[[ shop_name ]]"  is currently available on the platform.</p>',
            'mail_template_detail' => '<p>Hello [[ provider_name ]],</p><p>Your shop "[[ shop_name ]]"  is currently available on the platform.</p><p>Best regards,<br>[[ company_name ]]</p>',
        ]);
        ...
        $template = NotificationTemplate::create([
            ...
            'description' => 'Notification when shop status is deactivated',
            'status' => 1,
            'to' => '["admin","provider"]',
            'channels' => ['IS_MAIL' => '1', 'PUSH_NOTIFICATION' => '0', 'IS_SMS' => '0', 'IS_WHATSAPP' => '0'],
        ]);
        $template->defaultNotificationTemplateMap()->create([
            'language' => 'en',
            'notification_link' => '',
            'notification_message' => 'Shop "[[ shop_name ]]" status has been deactivated.',
            'user_type' => 'admin',
            'status' => 1,
            'subject' => 'Shop deactivated',
            'mail_subject' => 'Shop deactivated',
            'template_detail' => '<p>Hello [[ admin_name ]],</p><p>Shop "[[ shop_name ]]"  is currently not available on the platform.</p>',
            'mail_template_detail' => '<p>Hello [[ admin_name ]],</p><p>Shop "[[ shop_name ]]"  is currently not available on the platform.</p> <p>Best regards,<br>[[ company_name ]]</p>',
        ]);
        $template->defaultNotificationTemplateMap()->create([
            'language' => 'en',
            'notification_link' => '',
            'notification_message' => 'Your shop "[[ shop_name ]]" status has been updated.',
            'user_type' => 'provider',
            'status' => 1,
            'subject' => 'Shop deactivated',
            'mail_subject' => 'Your shop deactivated',
            'template_detail' => '<p>Hello [[ provider_name ]],</p><p>Your shop "[[ shop_name ]]"  is currently not available on the platform.</p>',
            'mail_template_detail' => '<p>Hello [[ provider_name ]],</p><p>Your shop "[[ shop_name ]]"  is currently not available on the platform.</p><p>Best regards,<br>[[ company_name ]]</p>',
        ]);
        ...
        $template = NotificationTemplate::create([
            ...
            'status' => 1,
            'to' => '["admin","provider","handyman","user"]',
            'channels' => ['IS_MAIL' => '1', 'PUSH_NOTIFICATION' => '0', 'IS_SMS' => '1', 'IS_WHATSAPP' => '1'],
        ]);
        $template->defaultNotificationTemplateMap()->create([
            'language' => 'en',
            'notification_link' => '',
        ...
        $template->defaultNotificationTemplateMap()->create([
            ...
            'mail_template_detail' => '<p>Welcome aboard! We are happy to have you on our team. Your expertise is going to be invaluable to our customers.</p> <p>Best regards,<br>The Handyman Service Team</p>',
        ]);
        $template->defaultNotificationTemplateMap()->create([
            'language' => 'en',
            'notification_link' => '',
            ...
            'mail_template_detail' => '<p>Welcome to the team! We are excited to have you on board. Your skills are going to be a huge asset to our customers.</p> <p>Best regards,<br>The Handyman Service Team</p>',
        ]);
        $template->defaultNotificationTemplateMap()->create([
            'language' => 'en',
            'notification_link' => '',
            ...
            'mail_template_detail' => '<p>Welcome! We are excited to have you join our community. We are looking forward to seeing how you will use our platform to achieve your goals.</p> <p>Best regards,<br>The Handyman Service Team</p>',
        ]);
        ...
        $template = NotificationTemplate::create([
            ...
            'description' => 'Notification when a new provider is auto-assigned the free plan',
            'status' => 1,
            'to' => '["admin","provider"]',
            'channels' => ['IS_MAIL' => '1', 'PUSH_NOTIFICATION' => '0', 'IS_SMS' => '0', 'IS_WHATSAPP' => '0'],
        ]);
        $template->defaultNotificationTemplateMap()->create([
            ...
            'mail_subject' => 'New provider assigned free trail',
            'whatsapp_subject' => 'New provider assigned free trail',
            'sms_subject' => 'New provider assigned free trail',
            ...
            'whatsapp_template_detail' => '<p>Hello [[ admin_name ]],</p><p>A new provider <strong>[[ provider_name ]]</strong> has been automatically assigned the free plan <strong>[[ plan_title ]]</strong> upon registration.</p>',
            'sms_template_detail' => '<p>Hello [[ admin_name ]],</p><p>A new provider <strong>[[ provider_name ]]</strong> has been automatically assigned the free plan <strong>[[ plan_title ]]</strong> upon registration.</p>',
            'mail_template_detail' => '<p>Hello [[ admin_name ]],</p><p>A new provider <strong>[[ provider_name ]]</strong> has been automatically assigned the free plan <strong>[[ plan_title ]]</strong> upon registration.</p><p>Best regards,<br>[[ company_name ]]</p>',
        ]);
        $template->defaultNotificationTemplateMap()->create([
            'language' => 'en',
            'notification_link' => '',
            ...
            'mail_subject' => 'Free plan assigned to you',
            'whatsapp_subject' => 'Free plan assigned to you',
            'sms_subject' => 'Free plan assigned to you',
            'template_detail' => '<p>Hello [[ provider_name ]],</p><p>Welcome! You have been automatically assigned the free plan <strong>[[ plan_title ]]</strong>. You can now use the platform services.</p>',
            'whatsapp_template_detail' => '<p>Hello [[ provider_name ]],</p><p>Welcome! You have been automatically assigned the free plan <strong>[[ plan_title ]]</strong>. You can now use the platform services.</p>',
            'sms_template_detail' => '<p>Hello [[ provider_name ]],</p><p>Welcome! You have been automatically assigned the free plan <strong>[[ plan_title ]]</strong>. You can now use the platform services.</p>',
            'mail_template_detail' => '<p>Hello [[ provider_name ]],</p><p>Welcome! You have been automatically assigned the free plan <strong>[[ plan_title ]]</strong>. You can now use the platform services.</p><p>Best regards,<br>[[ company_name ]]</p>',
        ]);
        ...
        $template = NotificationTemplate::create([
            ...
            'description' => 'Notification reminder when free plan is about to expire',
            'status' => 1,
            'to' => '["provider"]',
            'channels' => ['IS_MAIL' => '1', 'PUSH_NOTIFICATION' => '0', 'IS_SMS' => '0', 'IS_WHATSAPP' => '0'],
        ]);
        $template->defaultNotificationTemplateMap()->create([
            ...
            'user_type' => 'provider',
            'status' => 1,
            'subject' => 'Your free trail expires soon',
            'mail_subject' => 'Your free trail expires soon',
            'whatsapp_subject' => 'Your free trail expires soon',
            'sms_subject' => 'Your free trail expires soon',
            'template_detail' => '<p>Hello [[ provider_name ]],</p><p>Your free plan <strong>[[ plan_title ]]</strong> expires soon on [[ expiry_date ]]. Please upgrade to continue using our services.</p>',
            'whatsapp_template_detail' => '<p>Hello [[ provider_name ]],</p><p>Your free plan <strong>[[ plan_title ]]</strong> expires soon on [[ expiry_date ]]. Please upgrade to continue using our services.</p>',
            'sms_template_detail' => '<p>Hello [[ provider_name ]],</p><p>Your free plan <strong>[[ plan_title ]]</strong> expires soon on [[ expiry_date ]]. Please upgrade to continue using our services.</p>',
            'mail_template_detail' => '<p>Hello [[ provider_name ]],</p><p>Your free plan <strong>[[ plan_title ]]</strong> expires soon on [[ expiry_date ]]. Please upgrade to continue using our services.</p><p>Best regards,<br>[[ company_name ]]</p>',
        ]);
